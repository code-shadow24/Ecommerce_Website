...
import { createProduct, createProductVariants, deleteProduct, deleteProductVariants, getAllProducts, getNewArrivalProducts, getProductByCategory, getProductReviews, getProductVariants, getRelatedProducts, searchProducts, updateProduct, updateProductImage, updateProductVariants, updateVariantImage } from "../controllers/product.controller.js";
